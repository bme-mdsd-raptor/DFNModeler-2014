...
/**
 * This is the item provider adapter for a {@link DFN.InPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InPort_in_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InPort_in_feature", "_UI_InPort_type"),
				 DFNPackage.Literals.IN_PORT__IN,
				 true,
				 false,
				 true,
				 null,
