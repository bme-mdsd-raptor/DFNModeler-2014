...
/**
 * This is the item provider adapter for a {@link DFN.Token} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Token_nodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Token_nodes_feature", "_UI_Token_type"),
				 DFNPackage.Literals.TOKEN__NODES,
				 true,
				 false,
				 true,
				 null,
