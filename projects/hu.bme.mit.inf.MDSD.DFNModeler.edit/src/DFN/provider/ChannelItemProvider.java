...
/**
 * This is the item provider adapter for a {@link DFN.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DFNPackage.Literals.CHANNEL__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DFNPackage.Literals.CHANNEL__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTokenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_token_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_token_feature", "_UI_Channel_type"),
				 DFNPackage.Literals.CHANNEL__TOKEN,
				 true,
				 false,
				 true,
				 null,
