...
/**
 * This is the item provider adapter for a {@link DFN.EndPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndPointItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DFNPackage.Literals.END_POINT__PORTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EndPoint.class)) {
			case DFNPackage.END_POINT__PORTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DFNPackage.Literals.END_POINT__PORTS,
				 DFNFactory.eINSTANCE.createInPort()));

		newChildDescriptors.add
			(createChildParameter
				(DFNPackage.Literals.END_POINT__PORTS,
				 DFNFactory.eINSTANCE.createOutPort()));

		newChildDescriptors.add
			(createChildParameter
				(DFNPackage.Literals.END_POINT__PORTS,
				 DFNFactory.eINSTANCE.createInOutPort()));
	}
